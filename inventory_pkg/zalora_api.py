...
def get_token(brand):
    ...
    Supports both credential formats:
      dict  (current)  : {"client_id": "...", "client_secret": "..."}
      tuple (legacy)   : ("client_id_value", "client_secret_value")

    This is the single canonical implementation — zalora_stock_report.py
    ...
    if isinstance(creds, dict):
        ...
        client_id, client_secret = creds   # legacy tuple format
