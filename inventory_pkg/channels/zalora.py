...
from ..utils import (
    detect_brand_from_filename, detect_brand_from_file,
    get_shared_strings, xml_cell_val, scan_xlsx_bytes_headers_generic,
)
...
def scan_zalora_columns(file_paths):
    ...
    ZAL_MPSKU_ID and ZAL_MPITEM_ID are always appended for the GUI.
    """
    cols, seen = [], set()
    ...
    for extra in (COL_MPSKU_ID, COL_MPITEM_ID):
